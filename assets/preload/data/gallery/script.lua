function onCreate()
    ...
    makeLuaSprite('pic1', 'all parts for gallery/images/PicoSchool', 240, 150);
    setObjectCamera('pic1', 'hud');
    addLuaSprite('pic1', true);

    makeLuaSprite('pic2', 'all parts for gallery/images/PicoSchoolBlammed', 2000, 150);
    setObjectCamera('pic2', 'hud');
    addLuaSprite('pic2', true);

    makeLuaSprite('pic3', 'all parts for gallery/images/LoadingBlampini', 4000, 150);
    setObjectCamera('pic3', 'hud');
    addLuaSprite('pic3', true);
    
    makeLuaSprite('pic4', 'all parts for gallery/images/HotCocoa', 6000, -70);
    ...
    makeLuaText('choose', 'Press P to go to next page.', 0, 0, 660);
    addLuaText('choose');
