...
function onCreate()
    ...
    makeLuaText("sick", 'Swags: 0', 200, getProperty('cm.x'), getProperty('cm.y') + 30);
    makeLuaText("good", 'Nices: 0', 200, getProperty('cm.x'), getProperty('sick.y') + 30);
    makeLuaText("bad", 'Craps: 0', 200, getProperty('cm.x'), getProperty('good.y') + 30);
    makeLuaText("shit", 'FUCKs: 0', 200, getProperty('cm.x'), getProperty('bad.y') + 30);
...
function onUpdate(elapsed)
    ...
    setTextString('sick', 'Swags: ' .. getProperty('sicks'))
    setTextString('good', 'Nices: ' .. getProperty('goods'))
    setTextString('bad', 'Craps: ' .. getProperty('bads'))
    setTextString('shit', 'FUCKs: ' .. getProperty('shits'))
