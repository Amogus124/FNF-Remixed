...
function onCreate()
	...
	makeLuaSprite('windows', 'win4', -10, 0)
    ...
    makeAnimatedLuaSprite('Nene','RemixedNene',290,290)
    addAnimationByPrefix('Nene','bounce','Idlealt',35,false)
    addLuaSprite('Nene',false)
    scaleObject('Nene', 1.1, 1.1)
    
    makeAnimatedLuaSprite('Pico','PicoBG',1460,310)
    addAnimationByPrefix('Pico','danceleft','DanceLeft',35,false)
    addAnimationByPrefix('Pico','danceright','DanceRight',35,false)
...
function onBeatHit()--for every beat
    ...
    if curBeat % 4 == 1 then
        objectPlayAnimation('Pico','danceleft',true)
      end
    if curBeat % 4 == 3 then
        objectPlayAnimation('Pico','danceright',true)
      end
    if curBeat % 2 == 1 then
